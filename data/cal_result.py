...
if __name__ == "__main__":
    ...
    for i in range(4000-2000-1820):
        sram_res.append('xx')
    # conv2
    y = quantized_conv3d_debug(x, model.q_conv2_w, model.q_conv2_b)  # for debugging
    x = quantized_conv3d(x, model.q_conv2_w, model.q_conv2_b) # cal result
